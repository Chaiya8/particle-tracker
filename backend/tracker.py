...
class Tracker:
    ...
    '''
    Detect particles in every frame of a video
    '''
    ...
    '''
    Link particles in different frames to form tracks
    '''
    ...
    '''
    Detect particles in all videos in the root folder
    '''
    ...
    '''
    Link particles in all videos in the root folder
    '''
    ...
    '''
    Return a random frame from a random video in the root folder
    '''
